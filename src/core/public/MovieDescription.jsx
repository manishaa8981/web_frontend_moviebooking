...
//   return (
//     <span
//       className={`px-3 py-1 rounded-md text-sm font-medium ${variants[variant]}`}
//     >
//       {children}
//     </span>
//   );
...
//   return (
//     <button
//       className={`px-6 py-3 rounded-lg flex items-center gap-2 transition-colors ${variants[variant]} ${className}`}
//       {...props}
//     >
//       {children}
//     </button>
...
//           <img
//             src={
//               "http://localhost:4011/public/uploads/images/${movie.movie_image"
//             }
...
//                 {movie.movie_name}
//               </h1>
//               <p className="text-xl text-gray-700 mb-6">{movie.title}</p>
...
//                   />
//                   <div>
//                     <h3 className="font-semibold">{movie.cast_name}</h3>
